  ...
  async function fetchProducts() {
    try {
      ...
      const response = await fetch(
        `https://nita-shopi-backend-jo5u.onrender.com/api/v1/product/getOldProduct`, 
        {
          method: "GET",
          credentials: "include",
        }
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 p-6">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-6">There are no previously owned products available at the moment.</p>
          <Link 
            to="/" 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {products.map((product) => (
              <Card
                ...
                product_Owner={product.owner || "Unknown Owner"}
